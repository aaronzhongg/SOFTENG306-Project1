...
public class Greedy {
	...
	public Schedule greedySearch(Graph g, int procCount, ArrayList<Integer> root,Graph gVis){
		...
		//Main.update.updateColor(smallest.nodeIndex, smallest.Processor, gVis);//updates the color
		gVis.getNode(smallest.nodeIndex).addAttribute("ui.style", "text-style:bold-italic; text-size:18;");
		...
		while(!queue.isEmpty()){
			...
			//Main.update.updateColor(smallest.nodeIndex, smallest.Processor, gVis);
