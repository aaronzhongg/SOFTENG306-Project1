...
public MainView(Graph g){
	...
	String[] speedStrings = { "20", "50", "100", "300", "500","800","1000" };
	final JComboBox speedCmbo = new JComboBox(speedStrings);
	speedCmbo.setSelectedIndex(1);
	...
	final JButton start=new JButton("Replay Brunch-and-bound");
	...
	{     
		...
		public void actionPerformed(ActionEvent e)
		  {  
			  ...
			  initialThread(start);
			    	//  executor.shutdown();
			          Main.update.updateProcessorColor( Main.gVis);
...
private void initialThread(final JButton start){
